...
import { Zod_Cookie_Data_Type, Zod_Create_Token_Data_Type, Zod_Forget_Password_Type, Zod_Password_Change_Data_Type, Zod_Reset_Password_Type } from './auth.zod.validation';
...
router.post('/forget',Zod_Validation_Request(Zod_Forget_Password_Type),Auth_Contollers.Forget_Password_Controller)
// reset password route
router.patch('/reset',Zod_Validation_Request(Zod_Reset_Password_Type),Auth_Contollers.Reset_Password_Controller)
